...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于yolov5口罩检测"))
    ...
    def button_image_open(self):
        ...
        mkdir("../result/")
        cv2.imwrite('../result/prediction'+time.strftime("%m-%d-%h-%H-%M-%S", time.localtime())+'.jpg', showimg)
    ...
    def button_video_open(self):
        ...
        if flag == False:
            ...
            mkdir("../result/")
            self.out = cv2.VideoWriter('../result/prediction'+time.strftime("%m-%d-%h-%H-%M-%S", time.localtime())+'.avi', cv2.VideoWriter_fourcc(
